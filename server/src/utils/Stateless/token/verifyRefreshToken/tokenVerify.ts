...
import { verifyJWT } from "../tokenSign&Verify/jwtVerify";
import { REFRESH_TOKEN_VERIFY } from "../tokenConfig";
...
export const verifyRefreshToken = async (
  ...
  try {
    ...
    const tokenDetails = verifyJWT(refreshToken, REFRESH_TOKEN_VERIFY);
